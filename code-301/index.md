...
|----------------------------|--------|
| Clases en vivo (26)        | 78     |
| Actividades asíncronas     | 52     |
| **Total**                  | **130**|

**Total: 130 horas** ~ 14 semanas
...
- Implementar sistemas de autenticación y autorización con OAuth2 y NextAuth.js.
...
- _Proyecto-integrador_: **Agenda de Contactos con React**.
...
- _Proyecto-integrador_: **Agenda de Contactos con API y Routing**.
...
- _Proyecto-integrador_: **API REST profesional con Express**.
...
- _Proyecto-integrador_: **Aplicación Fullstack con base de datos en la nube**.
...
- _Proyecto-intermedio_: **Solución real para una empresa**.
...
- _Proyecto-integrador_: **MinCommerce - E-commerce con Next.js y TypeScript**.

### ▶︎ Módulo 7: Autenticación y Autorización
En este módulo, dominarás los sistemas modernos de autenticación y seguridad. Implementarás OAuth2, autorización basada en roles, protección de rutas con middleware y estrategias híbridas de sesión. Desarrollarás un sistema completo de seguridad que proteja aplicaciones de nivel empresarial.
- _Proyecto-integrador_: **MinCommerceSec - Sistema de autenticación y autorización**.
...
- _Proyecto-final_: **Solución real completa para una empresa**.
